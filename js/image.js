...
var scrollRight7 = document.getElementById('scroll-right7');
var scrollLeft7 = document.getElementById('scroll-left7');

var scrollRight8 = document.getElementById('scroll-right8');
var scrollLeft8 = document.getElementById('scroll-left8');

var scrollRight9 = document.getElementById('scroll-right9');
var scrollLeft9 = document.getElementById('scroll-left9');
...
scrollRight7.addEventListener('click', (event) => {
  imgList7.scrollBy(750, 0);
});

scrollLeft7.addEventListener('click', (event) => {
  imgList7.scrollBy(-750, 0);
});

scrollRight8.addEventListener('click', (event) => {
  imgList8.scrollBy(750, 0);
});

scrollLeft8.addEventListener('click', (event) => {
  imgList8.scrollBy(-750, 0);
});

scrollRight9.addEventListener('click', (event) => {
  imgList9.scrollBy(750, 0);
});

scrollLeft9.addEventListener('click', (event) => {
  imgList9.scrollBy(-750, 0);
});