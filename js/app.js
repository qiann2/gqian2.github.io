...
function airlinePopup() {
    var popup = document.getElementById("airlinePopup");
    popup.classList.toggle("show");
}

function chatappPopup() {
    var popup = document.getElementById("chatappPopup");
    popup.classList.toggle("show");
}

function bugPopup() {
    var popup = document.getElementById("bugPopup");
    popup.classList.toggle("show");
}

function cryptoPopup() {
    var popup = document.getElementById("cryptoPopup");
    popup.classList.toggle("show");
}
